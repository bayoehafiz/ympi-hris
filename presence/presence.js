var BasePagesPresence = function() {
    ...
    var initPresencePage = function() {
        ...
        $(document).on('click', '.tab-btn', function() {
            ...
            switch (t) {
                case 'employee_presence':
                    $('#btn-add').attr('data', 'Absensi Karyawan');
                    // initTableEmployeePresence();
                    break;
                default:
    ...
    var initTablePresence = function() {
        // init table BS style
        bsDataTables();

        // Table initiation
        var table = $('#table-presence').DataTable({
