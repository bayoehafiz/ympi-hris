...
if (str_replace(' ', '', $this->mainlogo) == '') {
    ...
    echo '<ul class="nav navbar-nav navbar-left"><li class="sitetitle"><a class="navbar-brand" href="' .dirname(dirname(__DIR__)). $this->base_url.'">'.$this->site_name.'</a></li></ul>';
} else {
    //Site main logo as link
    echo '<ul class="nav navbar-nav navbar-left"><li class="mainlogo"><a class="navbar-brand" href="'.dirname(dirname(__DIR__)).$this->base_url.'"><img src="'.$this->mainlogo.'" height="36px"></a></li></ul>';
}
?>
...
<?php
        ...
        //User not logged in?>
    <ul class="nav navbar-nav navbar-right">
    <li class="dropdown"><a class="btn btn-sm btn-default" href="<?php echo $this->base_url; ?>/login/index.php" role="button" aria-haspopup="false" aria-expanded="false">Sign In
    </a>
    </li>
    </ul>
