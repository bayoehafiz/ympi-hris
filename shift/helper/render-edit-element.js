...
window.renderEditElement = function(type, name, label, value, data_object, col_size, target_table) {
    var elem = '';

    if (type == 'daterange') {
        elem += '<div class="form-group">' +
            '<div class="col-md-' + col_size + ' push-10 push-10">' +
        ...
        elem += '<div class="col-md-' + col_size + ' push-20">' +
            '-' +
            '</div>';
    }
